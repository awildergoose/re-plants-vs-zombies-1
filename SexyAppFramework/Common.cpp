...
{
    return false;  // IsWindowsVistaOrGreater();
}
...
std::string Sexy::StringToUpper(const std::string& theString)
{
    ...
    for (unsigned i = 0; i < theString.length(); i++) aString += toupper(theString[i]);
...
std::wstring Sexy::StringToUpper(const std::wstring& theString)
{
    ...
    for (unsigned i = 0; i < theString.length(); i++) aString += towupper(theString[i]);
...
std::string Sexy::StringToLower(const std::string& theString)
{
    ...
    for (unsigned i = 0; i < theString.length(); i++) aString += tolower(theString[i]);
...
std::wstring Sexy::StringToWString(const std::string& theString)
{
    ...
    for (size_t i = 0; i < theString.length(); ++i) aString += (unsigned char)theString[i];
    return aString;
}
...
{
    int aStartPos = 0;
    while (aStartPos < (int)theString.length() && isspace(theString[aStartPos])) aStartPos++;

    int anEndPos = theString.length() - 1;
    while (anEndPos >= 0 && isspace(theString[anEndPos])) anEndPos--;
...
{  // 0x5AFD80
    int aStartPos = 0;
    while (aStartPos < (int)theString.length() && iswspace(theString[aStartPos])) aStartPos++;

    int anEndPos = theString.length() - 1;
    while (anEndPos >= 0 && iswspace(theString[anEndPos])) anEndPos--;
...
bool Sexy::Deltree(const std::string& thePath)
{
    ...
    if (_rmdir(thePath.c_str()) == 0) success = false;
