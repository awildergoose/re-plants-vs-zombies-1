...
class MemoryImage : public Image
{
   ...
   public:
    ...
    /*void					AdditiveDrawLineAA(double theStartX, double theStartY, double theEndX,
    ...
    bool StretchBltMirrorClipHelper(const Rect& theSrcRect, const Rect& theClipRect, const Rect& theDestRect,
                                    FRect& theSrcRectOut, Rect& theDestRectOut);
    void BltMatrixHelper(Image* theImage, float x, float y, const SexyMatrix3& theMatrix, const Rect& theClipRect,
