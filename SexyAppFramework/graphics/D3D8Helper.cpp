...
DECLARE_INTERFACE_(IDirect3D8, IUnknown)
{
    ...
    STDMETHOD(GetDeviceCaps)(THIS_ UINT Adapter, D3DDEVTYPE DeviceType, DDCAPS * pCaps) PURE;
...
static bool GetD3D8AdapterInfo2(GUID& theGUID, std::string& theDriver, std::string& theDescription)
{
    ...
    Direct3DCreate8Func aDirect3DCreate8Func = SexyGetProc<Direct3DCreate8Func>(gD3D8Lib, "Direct3DCreate8");
