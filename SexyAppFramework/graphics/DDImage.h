...
class DDImage : public MemoryImage
{
   ...
   public:
    ...
    virtual void NormalDrawLine(double theStartX, double theStartY, double theEndX, double theEndY,
                                const Color& theColor);
    virtual void AdditiveDrawLine(double theStartX, double theStartY, double theEndX, double theEndY,
                                  const Color& theColor);
    virtual void NormalDrawLineAA(double theStartX, double theStartY, double theEndX, double theEndY,
                                  const Color& theColor);
    /*virtual void			AdditiveDrawLineAA(double theStartX, double theStartY, double theEndX, double
     * theEndY, const Color& theColor);*/
   ...
   public:
    ...
    virtual void BltMatrix(Image* theImage, float x, float y, const SexyMatrix3& theMatrix, const Rect& theClipRect,
