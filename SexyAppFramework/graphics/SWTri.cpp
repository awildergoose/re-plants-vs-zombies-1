    ...
    for (;;)
    {
        ...
        if (vCount)
        {
            ...
            if (textured)
            {
                ...
                // int>(mSWTexture->mTextureInfo.lPitch) / (mSWTexture->mTextureInfo.ddpfPixelFormat.dwRGBBitCount / 8);
...
void Sexy::SWTri_AddDrawTriFunc(bool textured, bool talpha, bool mod_argb, bool global_argb, int thePixelFormat,
