...
void D3DTestImage::FillRect(int x, int y, int theWidth, int theHeight, DWORD theColor)
{
    ...
    {
        DWORD* aPixel = aRow;
        for (int i = 0; i < theWidth; i++) *aPixel++ = theColor;
...
{
    for (int i = 0; i < mWidth; i++) FillRect(i, 0, 1, mHeight, i & 1 ? 0xFFFFFFFF : 0xFF000000);
}
...
void D3DTestImage::CopyToTexture8888(LPDIRECTDRAWSURFACE7 theTexture, int offx, int offy, int texWidth, int texHeight)
{
    ...
    if (aWidth > 0 && aHeight > 0)
    {
        ...
        for (int y = 0; y < aHeight; y++)
        {
            ...
            for (int x = 0; x < aWidth; x++) *dst++ = *src++;
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void D3DTestImage::DrawPieceToDevice(LPDIRECT3DDEVICE7 theDevice, LPDIRECTDRAWSURFACE7 theTexture, float x, float y,
                                     int offx, int offy, int texWidth, int texHeight, DWORD theColor)
{
...
///////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////
void D3DTestImage::DrawToDevice(LPDIRECT3DDEVICE7 theDevice, LPDIRECTDRAWSURFACE7 theTexture, int x, int y,
                                DWORD theColor)
{
    int aWidth  = GetWidth();
...
bool D3DTester::Init(HWND theHWND, LPDIRECTDRAW7 theDDraw)
{
    ...
    if (mCheckRegistry)
    {
        ...
        RegCreateKeyExA(HKEY_CURRENT_USER, aKey.c_str(), 0, (char*)"", REG_OPTION_NON_VOLATILE, KEY_ALL_ACCESS, NULL,
                        &mRegKey, NULL);
    }
    ...
    try
    {
        if (theDDraw == NULL)
        {
            ...
            typedef HRESULT(WINAPI * DirectDrawCreateExFunc)(GUID FAR * lpGUID, LPVOID * lplpDD, REFIID iid,
                                                             IUnknown FAR * pUnkOuter);
            DirectDrawCreateExFunc aDirectDrawCreateExFunc = reinterpret_cast<DirectDrawCreateExFunc>(
        ...
        else
        {
            ...
            // (aBPP/8)*aWidth*aHeight; dwTotal /= (1024*1024); if (total64bit < mMinVidMemory) 	return Fail("Not
            // enough
