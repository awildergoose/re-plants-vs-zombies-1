...
ListDataElement& ListDataElement::operator=(const ListDataElement& theListDataElement)
{
    ...
    for (i = 0; i < mElementVector.size(); i++) delete mElementVector[i];
...
bool FontData::HandleCommand(const ListDataElement& theParams)
{
    ...
    if (_stricmp(aCmd.c_str(), "Define") == 0)
    {
    ...
    else if (_stricmp(aCmd.c_str(), "CreateHorzSpanRectList") == 0)
    {
    ...
    else if (_stricmp(aCmd.c_str(), "SetDefaultPointSize") == 0)
    {
    ...
    else if (_stricmp(aCmd.c_str(), "SetCharMap") == 0)
    {
        if (theParams.mElementVector.size() == 3)
        {
    ...
    else if (_stricmp(aCmd.c_str(), "CreateLayer") == 0)
    {
        if (theParams.mElementVector.size() == 2)
        {
            if (!theParams.mElementVector[1]->mIsList)
    ...
    else if (_stricmp(aCmd.c_str(), "CreateLayerFrom") == 0)
    {
        if (theParams.mElementVector.size() == 3)
        {
    ...
    else if (_stricmp(aCmd.c_str(), "LayerRequireTags") == 0)
    {
        if (theParams.mElementVector.size() == 3)
        {
            FontLayer*   aLayer;
    ...
    else if (_stricmp(aCmd.c_str(), "LayerExcludeTags") == 0)
    {
        if (theParams.mElementVector.size() == 3)
        {
            FontLayer*   aLayer;
    ...
    else if (_stricmp(aCmd.c_str(), "LayerPointRange") == 0)
    {
        if (theParams.mElementVector.size() == 4)
        {
            FontLayer* aLayer;
    ...
    else if (_stricmp(aCmd.c_str(), "LayerSetPointSize") == 0)
    {
        if (theParams.mElementVector.size() == 3)
        {
            FontLayer* aLayer;
    ...
    else if (_stricmp(aCmd.c_str(), "LayerSetHeight") == 0)
    {
        if (theParams.mElementVector.size() == 3)
        {
            FontLayer* aLayer;
    ...
    else if (_stricmp(aCmd.c_str(), "LayerSetImage") == 0)
    {
        if (theParams.mElementVector.size() == 3)
        {
            FontLayer*  aLayer;
    ...
    else if (_stricmp(aCmd.c_str(), "LayerSetDrawMode") == 0)
    {
        if (theParams.mElementVector.size() == 3)
        {
            FontLayer* aLayer;
    ...
    else if (_stricmp(aCmd.c_str(), "LayerSetColorMult") == 0)
    {
        if (theParams.mElementVector.size() == 3)
        {
            FontLayer* aLayer;
    ...
    else if (_stricmp(aCmd.c_str(), "LayerSetColorAdd") == 0)
    {
        if (theParams.mElementVector.size() == 3)
        {
            FontLayer* aLayer;
    ...
    else if (_stricmp(aCmd.c_str(), "LayerSetAscent") == 0)
    {
        if (theParams.mElementVector.size() == 3)
        {
            FontLayer* aLayer;
    ...
    else if (_stricmp(aCmd.c_str(), "LayerSetAscentPadding") == 0)
    {
        if (theParams.mElementVector.size() == 3)
        {
            FontLayer* aLayer;
    ...
    else if (_stricmp(aCmd.c_str(), "LayerSetLineSpacingOffset") == 0)
    {
        if (theParams.mElementVector.size() == 3)
        {
            FontLayer* aLayer;
    ...
    else if (_stricmp(aCmd.c_str(), "LayerSetOffset") == 0)
    {
        if (theParams.mElementVector.size() == 3)
        {
            FontLayer* aLayer;
    ...
    else if (_stricmp(aCmd.c_str(), "LayerSetCharWidths") == 0)
    {
        if (theParams.mElementVector.size() == 4)
        {
            FontLayer*   aLayer;
    ...
    else if (_stricmp(aCmd.c_str(), "LayerSetSpacing") == 0)
    {
        if (theParams.mElementVector.size() == 3)
        {
            FontLayer* aLayer;
    ...
    else if (_stricmp(aCmd.c_str(), "LayerSetImageMap") == 0)
    {
        if (theParams.mElementVector.size() == 4)
        {
            FontLayer*      aLayer;
                ...
                (DataToList(theParams.mElementVector[3], &aRectList)))
            {
                if (aCharsVector.size() == aRectList.mElementVector.size())
                {
                    if ((Image*)aLayer->mImage != NULL)
                    {
                        ...
                        // aLayer->mCharData[aCharNum].mOffset.mY > aLayer->mDefaultHeight)
    ...
    else if (_stricmp(aCmd.c_str(), "LayerSetCharOffsets") == 0)
    {
        if (theParams.mElementVector.size() == 4)
        {
            FontLayer*      aLayer;
    ...
    else if (_stricmp(aCmd.c_str(), "LayerSetKerningPairs") == 0)
    {
        if (theParams.mElementVector.size() == 4)
        {
            FontLayer*   aLayer;
    ...
    else if (_stricmp(aCmd.c_str(), "LayerSetBaseOrder") == 0)
    {
        if (theParams.mElementVector.size() == 3)
        {
            FontLayer* aLayer;
    ...
    else if (_stricmp(aCmd.c_str(), "LayerSetCharOrders") == 0)
    {
        if (theParams.mElementVector.size() == 4)
        {
            FontLayer*   aLayer;
    ...
    else if (_stricmp(aCmd.c_str(), "LayerSetExInfo") == 0)
    {
    }
    else
    {
    ...
    while (anItr != mActiveLayerList.end())
    {
        ...
        else
        {
            ...
            if (thePrevChar != 0)
            {
                // aSpacing = (anActiveFontLayer->mBaseFontLayer->mSpacing +
                //	anActiveFontLayer->mBaseFontLayer->mCharData[(uchar) thePrevChar].mKerningOffsets[(uchar)
                // theChar]) * aPointSize / aLayerPointSize;
                aSpacing = (anActiveFontLayer->mBaseFontLayer->mSpacing +
                            anActiveFontLayer->mBaseFontLayer->GetCharData(thePrevChar)->mKerningOffsets[theChar]) *
                           aPointSize / aLayerPointSize;
            }
...
void ImageFont::DrawStringEx(Graphics* g, int theX, int theY, const SexyString& theString, const Color& theColor,
    ...
    for (ulong aCharNum = 0; aCharNum < theString.length(); aCharNum++)
    {
        ...
        while (anItr != mActiveLayerList.end())
        {
            ...
            if (theDrawnAreas != NULL)
            {
                ...
                Rect aDestRect(anImageX, anImageY, anActiveFontLayer->mScaledCharImageRects[aChar].mWidth,
...
void ImageFont::DrawString(Graphics* g, int theX, int theY, const SexyString& theString, const Color& theColor,
