...
void TextWidget::DrawColorStringHilited(Graphics* g, const SexyString& theString, int x, int y, int theStartPos,
                                        int theEndPos)
{
...
void TextWidget::AddToPhysicalLines(int theIdx, const SexyString& theLine)
{
    ...
    else
    {
        ...
        while (aCurPos < (int)theLine.length())
        {
            ...
            while ((aNextCheckPos < (int)theLine.length()) && (theLine[aNextCheckPos] == ' ')) aNextCheckPos++;
