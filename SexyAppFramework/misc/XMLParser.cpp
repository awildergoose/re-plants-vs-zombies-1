...
void XMLParser::SetStringSource(const std::wstring& theString)
{
    ...
    for (int i = 0; i < aSize; i++) mBufferedText[i] = theString[aSize - i - 1];
}
                            ...
                            if (theElement->mType == XMLElement::TYPE_START)
                            {
                                ...
                                else
                                {
                                    ...
                                    if (aAttributeKey.length() > 0)
                                    {
                                        ...
                                        AddAttribute(theElement, WStringToSexyString(aLastAttributeKey),
                            ...
                            if (hasSpace)
                            {
                                    ...
                                    ((AttributeVal) && ((aAttributeValue.length() > 0) || gotEndQuote)))
                                {
                                    if (doingAttribute)
                                    {
                                        ...
                                        AddAttribute(theElement, WStringToSexyString(aAttributeKey),
                                                     WStringToSexyString(aAttributeValue));
