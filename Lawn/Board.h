...
class Board : public Widget, public ButtonListener
{
   ...
   public:
    ...
    //  inline bool						SyncState(DataSync& theDataSync) { /* 未发现 */return
    //  true; }
    ...
    int             KillAllZombiesInRadius(int theRow, int theX, int theY, int theRadius, int theRowRange, bool theBurn,
                                           int theDamageRangeFlags);  // @Patoke: modified function prototype
    ...
    /*inline*/ void      DisplayAdviceAgain(const SexyString& theAdvice, MessageStyle theMessageStyle,
