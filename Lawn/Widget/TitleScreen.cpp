...
void TitleScreen::Draw(Graphics* g)
{
    ...
    if (mTitleState == TitleState::TITLESTATE_POPCAP_LOGO)
    {
        ...
        {
            anAlpha = TodAnimateCurve(mTitleStateDuration, mTitleStateDuration - 50, mTitleStateCounter, 0, 255,
    ...
    if (mTitleState == TitleState::TITLESTATE_PARTNER_LOGO)
    {
        ...
        {
            anAlpha = TodAnimateCurve(mTitleStateDuration, mTitleStateDuration - 35, mTitleStateCounter, 0, 255,
                                      TodCurves::CURVE_LINEAR);
    ...
    else
    {
        ...
        TodScaleRotateTransformMatrix(aTransform, aGrassX + 11.0f + aRollLen, aGrassY - 3.0f - 35.0f * aScale + 35.0f,
                                      aRotation, aScale, aScale);
