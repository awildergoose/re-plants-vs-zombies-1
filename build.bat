...
cmake --build build && copy ".\build\SexyAppFramework.exe" "G:\programs\Steam\steamapps\common\Plants Vs Zombies\SexyAppFramework.exe" && cd /d "G:\programs\Steam\steamapps\common\Plants Vs Zombies" && start "" "SexyAppFramework.exe" -tod
