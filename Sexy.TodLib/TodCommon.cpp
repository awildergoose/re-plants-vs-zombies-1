...
float TodCalcSmoothWeight(float aWeight, float aLastPicked, float aSecondLastPicked)
{
    ...
    float aFactor1 =
        1.0f + aAdvancedLength1 / aExpectedLength1 * 2.0f;  // = aWeight * aLastPicked * 2 + aWeight * 2 - 1
...
// 0x511CE0
void TodDrawString(Graphics* g, const SexyString& theText, int thePosX, int thePosY, _Font* theFont,
...
// 0x511E50
void TodDrawStringMatrix(Graphics* g, const _Font* theFont, const SexyMatrix3& theMatrix, const SexyString& theString,
...
// 0x513660
SexyString TodReplaceString(const SexyString& theText, const SexyChar* theStringToFind,
