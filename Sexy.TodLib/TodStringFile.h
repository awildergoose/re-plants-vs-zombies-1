...
class TodStringListFormat
{
   ...
   public:
    TodStringListFormat();
    TodStringListFormat(const char* theFormatName, _Font** theFont, const Color& theColor, int theLineSpacingOffset,
...
int TodWriteString(Graphics* g, const SexyString& theString, int theX, int theY, TodStringListFormat& theCurrentFormat,
                   ...
                   int theLength);
/*inline*/ int  TodWriteWordWrappedHelper(Graphics* g, const SexyString& theString, int theX, int theY,
                                          TodStringListFormat& theCurrentFormat, int theWidth,
                                          DrawStringJustification theJustification, bool drawString, int theOffset,
                                          int theLength, int theMaxChars);
...
/*inline*/ void TodDrawStringWrapped(Graphics* g, const SexyString& theText, const Rect& theRect, _Font* theFont,
