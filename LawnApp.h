...
class LawnApp : public SexyApp
{
   ...
   public:
    ...
    int               LawnMessageBox(int theDialogId, const SexyChar* theHeaderName, const SexyChar* theLinesName,
    ...
    //	void							TraceLoadGroup(const char* theGroupName, int
    // theGroupTime, int theTotalGroupWeigth, int theTaskWeight);
