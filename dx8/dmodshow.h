...
#define __IDMOWrapperFilter_INTERFACE_DEFINED__
    ...
    typedef struct IDMOWrapperFilterVtbl
    {
        ...
        HRESULT(STDMETHODCALLTYPE* QueryInterface)(IDMOWrapperFilter*         This,
                                                   /* [in] */ REFIID          riid,
...
#define IDMOWrapperFilter_Init(This, clsidDMO, catDMO) (This)->lpVtbl->Init(This, clsidDMO, catDMO)
    ...
    HRESULT STDMETHODCALLTYPE IDMOWrapperFilter_Init_Proxy(IDMOWrapperFilter* This, REFCLSID clsidDMO, REFCLSID catDMO);

    void __RPC_STUB IDMOWrapperFilter_Init_Stub(IRpcStubBuffer* This, IRpcChannelBuffer* _pRpcChannelBuffer,
