...
#define DD_ROP_SPACE (256 / 32)  // space required to store ROP array
    ...
    typedef struct _DDCAPS_DX5
    {
        ...
        /* 94*/ DWORD
        dwMaxLiveVideoStretch;  // maximum live video stretch factor multiplied by 1000, eg 1000 == 1.0, 1300 == 1.3
        /* 98*/ DWORD dwMinHwCodecStretch;  // minimum hardware codec stretch factor multiplied by 1000, eg 1000 == 1.0,
                                            // 1300 == 1.3
        /* 9c*/ DWORD dwMaxHwCodecStretch;  // maximum hardware codec stretch factor multiplied by 1000, eg 1000 == 1.0,
                                            // 1300 == 1.3
...
typedef DDCAPS_DX7 DDCAPS;
    ...
    typedef struct _DDPIXELFORMAT
    {
        ...
        union
        {
            ...
            DWORD dwStencilBitDepth;   // how many stencil bits (note: dwZBufferBitDepth-dwStencilBitDepth is total
                                       // Z-only bits)
