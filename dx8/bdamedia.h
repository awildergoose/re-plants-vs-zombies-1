...
//
#define STATIC_PINNAME_BDA_TRANSPORT 0x78216a81, 0xcfa8, 0x493e, 0x97, 0x11, 0x36, 0xa6, 0x1c, 0x8, 0xbd, 0x9d
...
//
#define STATIC_PINNAME_BDA_ANALOG_VIDEO 0x5c0c8281, 0x5667, 0x486c, 0x84, 0x82, 0x63, 0xe3, 0x1f, 0x1, 0xa6, 0xe9
...
//
#define STATIC_PINNAME_BDA_ANALOG_AUDIO 0xd28a580a, 0x9b1f, 0x4b0c, 0x9c, 0x33, 0x9b, 0xf0, 0xa8, 0xea, 0x63, 0x6b
...
//
#define STATIC_PINNAME_BDA_FM_RADIO 0xd2855fed, 0xb2d3, 0x4eeb, 0x9b, 0xd0, 0x19, 0x34, 0x36, 0xa2, 0xf8, 0x90
...
//
#define STATIC_PINNAME_BDA_IF_PIN 0x1a9d4a42, 0xf3cd, 0x48a1, 0x9a, 0xea, 0x71, 0xde, 0x13, 0x3c, 0xbe, 0x14
...
//
#define STATIC_PINNAME_BDA_OPENCABLE_PSIP_PIN 0x297bb104, 0xe5c9, 0x4ace, 0xb1, 0x23, 0x95, 0xc3, 0xcb, 0xb2, 0x4d, 0x4f
...
//
#define STATIC_KSPROPSETID_BdaEthernetFilter 0x71985f43, 0x1ca1, 0x11d3, 0x9c, 0xc8, 0x0, 0xc0, 0x4f, 0x79, 0x71, 0xe0
...
#define DEFINE_KSPROPERTY_ITEM_BDA_ETHERNET_FILTER_MULTICAST_LIST_SIZE(GetHandler, SetHandler)                   \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_ETHERNET_FILTER_MULTICAST_LIST_SIZE, (GetHandler), sizeof(KSPROPERTY), \
                           sizeof(ULONG), FALSE, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_ETHERNET_FILTER_MULTICAST_LIST(GetHandler, SetHandler)                   \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_ETHERNET_FILTER_MULTICAST_LIST, (GetHandler), sizeof(KSPROPERTY), \
                           sizeof(BDA_ETHERNET_ADDRESS_LIST), (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_ETHERNET_FILTER_MULTICAST_MODE(GetHandler, SetHandler)                   \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_ETHERNET_FILTER_MULTICAST_MODE, (GetHandler), sizeof(KSPROPERTY), \
                           sizeof(BDA_MULTICAST_MODE), (SetHandler), NULL, 0, NULL, NULL, 0)
...
//
#define STATIC_KSPROPSETID_BdaIPv4Filter 0x71985f44, 0x1ca1, 0x11d3, 0x9c, 0xc8, 0x0, 0xc0, 0x4f, 0x79, 0x71, 0xe0
...
#define DEFINE_KSPROPERTY_ITEM_BDA_IPv4_FILTER_MULTICAST_LIST_SIZE(GetHandler, SetHandler)                   \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_IPv4_FILTER_MULTICAST_LIST_SIZE, (GetHandler), sizeof(KSPROPERTY), \
                           sizeof(ULONG), FALSE, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_IPv4_FILTER_MULTICAST_LIST(GetHandler, SetHandler)                   \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_IPv4_FILTER_MULTICAST_LIST, (GetHandler), sizeof(KSPROPERTY), \
                           sizeof(BDA_IPv4_ADDRESS_LIST), (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_IPv4_FILTER_MULTICAST_MODE(GetHandler, SetHandler)                   \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_IPv4_FILTER_MULTICAST_MODE, (GetHandler), sizeof(KSPROPERTY), \
                           sizeof(BDA_MULTICAST_MODE), (SetHandler), NULL, 0, NULL, NULL, 0)
...
//
#define STATIC_KSPROPSETID_BdaIPv6Filter 0xe1785a74, 0x2a23, 0x4fb3, 0x92, 0x45, 0xa8, 0xf8, 0x80, 0x17, 0xef, 0x33
...
#define DEFINE_KSPROPERTY_ITEM_BDA_IPv6_FILTER_MULTICAST_LIST_SIZE(GetHandler, SetHandler)                   \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_IPv6_FILTER_MULTICAST_LIST_SIZE, (GetHandler), sizeof(KSPROPERTY), \
                           sizeof(ULONG), FALSE, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_IPv6_FILTER_MULTICAST_LIST(GetHandler, SetHandler)                   \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_IPv6_FILTER_MULTICAST_LIST, (GetHandler), sizeof(KSPROPERTY), \
                           sizeof(BDA_IPv6_ADDRESS_LIST), (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_IPv6_FILTER_MULTICAST_MODE(GetHandler, SetHandler)                   \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_IPv6_FILTER_MULTICAST_MODE, (GetHandler), sizeof(KSPROPERTY), \
                           sizeof(BDA_MULTICAST_MODE), (SetHandler), NULL, 0, NULL, NULL, 0)
...
//
#define STATIC_KSPROPSETID_BdaSignal 0xd2f1644b, 0xb409, 0x11d2, 0xbc, 0x69, 0x0, 0xa0, 0xc9, 0xee, 0x9e, 0x16
...
#define DEFINE_KSPROPERTY_ITEM_BDA_SIGNAL_SOURCE(GetHandler, SetHandler)                                  \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_SIGNAL_SOURCE, (GetHandler), sizeof(KSPROPERTY), sizeof(ULONG), \
                           (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_SIGNAL_TUNING_SPACE(GetHandler, SetHandler)                                 \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_SIGNAL_TUNING_SPACE, (GetHandler), sizeof(KSPROPERTY), sizeof(GUID), \
                           (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_SIGNAL_NETWORK_TYPE(GetHandler, SetHandler)                                 \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_SIGNAL_NETWORK_TYPE, (GetHandler), sizeof(KSPROPERTY), sizeof(GUID), \
                           (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_SIGNAL_STATE(GetHandler, SetHandler)                                             \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_SIGNAL_STATE, (GetHandler), sizeof(KSPROPERTY), sizeof(BDA_SIGNAL_STATE), \
                           (SetHandler), NULL, 0, NULL, NULL, 0)
...
//
#define STATIC_KSMETHODSETID_BdaChangeSync 0xfd0a5af3, 0xb41d, 0x11d2, 0x9c, 0x95, 0x0, 0xc0, 0x4f, 0x79, 0x71, 0xe0
...
#define DEFINE_KSMETHOD_ITEM_BDA_START_CHANGES(MethodHandler, SupportHandler)                                  \
    DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_START_CHANGES, KSMETHOD_TYPE_NONE, (MethodHandler), sizeof(KSMETHOD), 0, \
                         SupportHandler)

#define DEFINE_KSMETHOD_ITEM_BDA_CHECK_CHANGES(MethodHandler, SupportHandler)                                  \
    DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_CHECK_CHANGES, KSMETHOD_TYPE_NONE, (MethodHandler), sizeof(KSMETHOD), 0, \
                         SupportHandler)

#define DEFINE_KSMETHOD_ITEM_BDA_COMMIT_CHANGES(MethodHandler, SupportHandler)                                  \
    DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_COMMIT_CHANGES, KSMETHOD_TYPE_NONE, (MethodHandler), sizeof(KSMETHOD), 0, \
                         SupportHandler)

#define DEFINE_KSMETHOD_ITEM_BDA_GET_CHANGE_STATE(MethodHandler, SupportHandler)                                  \
    DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_GET_CHANGE_STATE, KSMETHOD_TYPE_READ, (MethodHandler), sizeof(KSMETHOD), 0, \
                         SupportHandler)
...
#define DEFINE_KSMETHOD_ITEM_BDA_CREATE_PIN_FACTORY(MethodHandler, SupportHandler)                              \
    DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_CREATE_PIN_FACTORY, KSMETHOD_TYPE_READ, (MethodHandler), sizeof(KSM_PIN), \
                         sizeof(ULONG), SupportHandler)

#define DEFINE_KSMETHOD_ITEM_BDA_DELETE_PIN_FACTORY(MethodHandler, SupportHandler)                                 \
    DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_DELETE_PIN_FACTORY, KSMETHOD_TYPE_NONE, (MethodHandler), sizeof(KSM_PIN), 0, \
                         SupportHandler)

#define DEFINE_KSMETHOD_ITEM_BDA_CREATE_TOPOLOGY(MethodHandler, SupportHandler)                                \
    DEFINE_KSMETHOD_ITEM(KSMETHOD_BDA_CREATE_TOPOLOGY, KSMETHOD_TYPE_WRITE, (MethodHandler), sizeof(KSMETHOD), \
                         sizeof(KSMULTIPLE_ITEM), SupportHandler)
...
//
#define STATIC_KSPROPSETID_BdaTopology 0xa14ee835, 0x0a23, 0x11d3, 0x9c, 0xc7, 0x0, 0xc0, 0x4f, 0x79, 0x71, 0xe0
...
#define DEFINE_KSPROPERTY_ITEM_BDA_NODE_TYPES(GetHandler, SetHandler)                                                  \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_NODE_TYPES, (GetHandler), sizeof(KSPROPERTY), 0, FALSE, NULL, 0, NULL, NULL, \
                           0)

#define DEFINE_KSPROPERTY_ITEM_BDA_PIN_TYPES(GetHandler, SetHandler) \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_PIN_TYPES, (GetHandler), sizeof(KSPROPERTY), 0, FALSE, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_TEMPLATE_CONNECTIONS(GetHandler, SetHandler)                   \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_TEMPLATE_CONNECTIONS, (GetHandler), sizeof(KSPROPERTY), \
                           sizeof(BDA_TEMPLATE_CONNECTION), FALSE, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_NODE_METHODS(GetHandler, SetHandler)                                            \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_NODE_METHODS, (GetHandler), sizeof(KSPROPERTY), 0, FALSE, NULL, 0, NULL, \
                           NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_NODE_PROPERTIES(GetHandler, SetHandler)                                            \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_NODE_PROPERTIES, (GetHandler), sizeof(KSPROPERTY), 0, FALSE, NULL, 0, NULL, \
                           NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_NODE_EVENTS(GetHandler, SetHandler)                                            \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_NODE_EVENTS, (GetHandler), sizeof(KSPROPERTY), 0, FALSE, NULL, 0, NULL, \
                           NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_CONTROLLING_PIN_ID(GetHandler, SetHandler)                                        \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_CONTROLLING_PIN_ID, (GetHandler), sizeof(KSP_BDA_NODE_PIN), sizeof(ULONG), \
                           FALSE, NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_NODE_DESCRIPTORS(GetHandler, SetHandler)                                            \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_NODE_DESCRIPTORS, (GetHandler), sizeof(KSPROPERTY), 0, FALSE, NULL, 0, NULL, \
                           NULL, 0)
...
//
#define STATIC_KSPROPSETID_BdaPinControl 0xded49d5, 0xa8b7, 0x4d5d, 0x97, 0xa1, 0x12, 0xb0, 0xc1, 0x95, 0x87, 0x4d
...
#define DEFINE_KSPROPERTY_ITEM_BDA_PIN_ID(GetHandler, SetHandler)                                                  \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_PIN_ID, (GetHandler), sizeof(KSPROPERTY), sizeof(ULONG), FALSE, NULL, 0, \
                           NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_PIN_TYPE(GetHandler, SetHandler)                                                  \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_PIN_TYPE, (GetHandler), sizeof(KSPROPERTY), sizeof(ULONG), FALSE, NULL, 0, \
                           NULL, NULL, 0)
...
//
#define STATIC_KSEVENTSETID_BdaPinEvent 0x104781cd, 0x50bd, 0x40d5, 0x95, 0xfb, 0x08, 0x7e, 0xe, 0x86, 0xa5, 0x91
...
#define DEFINE_KSEVENT_ITEM_BDA_PIN_CONNECTED(AddHandler, RemoveHandler, SupportHandler)                  \
    DEFINE_KSEVENT_ITEM(KSEVENT_BDA_PIN_CONNECTED, sizeof(KSEVENTDATA), 0, (AddHandler), (RemoveHandler), \
                        (SupportHandler))

#define DEFINE_KSEVENT_ITEM_BDA_PIN_DISCONNECTED(AddHandler, RemoveHandler, SupportHandler)                  \
    DEFINE_KSEVENT_ITEM(KSEVENT_BDA_PIN_DISCONNECTED, sizeof(KSEVENTDATA), 0, (AddHandler), (RemoveHandler), \
                        (SupportHandler))
...
//
#define STATIC_KSPROPSETID_BdaVoidTransform 0x71985f46, 0x1ca1, 0x11d3, 0x9c, 0xc8, 0x0, 0xc0, 0x4f, 0x79, 0x71, 0xe0
...
#define DEFINE_KSPROPERTY_ITEM_BDA_VOID_TRANSFORM_START(GetHandler, SetHandler)                                      \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_VOID_TRANSFORM_START, FALSE, sizeof(KSPROPERTY), 0, (SetHandler), NULL, 0, \
                           NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_VOID_TRANSFORM_STOP(GetHandler, SetHandler)                                      \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_VOID_TRANSFORM_STOP, FALSE, sizeof(KSPROPERTY), 0, (SetHandler), NULL, 0, \
                           NULL, NULL, 0)
...
//
#define STATIC_KSPROPSETID_BdaNullTransform 0xddf15b0d, 0xbd25, 0x11d2, 0x9c, 0xa0, 0x0, 0xc0, 0x4f, 0x79, 0x71, 0xe0
...
#define DEFINE_KSPROPERTY_ITEM_BDA_NULL_TRANSFORM_START(GetHandler, SetHandler)                                      \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_NULL_TRANSFORM_START, FALSE, sizeof(KSPROPERTY), 0, (SetHandler), NULL, 0, \
                           NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_NULL_TRANSFORM_STOP(GetHandler, SetHandler)                                      \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_NULL_TRANSFORM_STOP, FALSE, sizeof(KSPROPERTY), 0, (SetHandler), NULL, 0, \
                           NULL, NULL, 0)
...
//
#define STATIC_KSPROPSETID_BdaFrequencyFilter 0x71985f47, 0x1ca1, 0x11d3, 0x9c, 0xc8, 0x0, 0xc0, 0x4f, 0x79, 0x71, 0xe0
...
#define DEFINE_KSPROPERTY_ITEM_BDA_RF_TUNER_FREQUENCY(GetHandler, SetHandler)                                \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_RF_TUNER_FREQUENCY, (GetHandler), sizeof(KSP_NODE), sizeof(ULONG), \
                           (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_RF_TUNER_POLARITY(GetHandler, SetHandler)                                \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_RF_TUNER_POLARITY, (GetHandler), sizeof(KSP_NODE), sizeof(ULONG), \
                           (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_RF_TUNER_RANGE(GetHandler, SetHandler)                                              \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_RF_TUNER_RANGE, (GetHandler), sizeof(KSP_NODE), sizeof(ULONG), (SetHandler), \
                           NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_RF_TUNER_TRANSPONDER(GetHandler, SetHandler)                                \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_RF_TUNER_TRANSPONDER, (GetHandler), sizeof(KSP_NODE), sizeof(ULONG), \
                           (SetHandler), NULL, 0, NULL, NULL, 0)
...
#define DEFINE_KSPROPERTY_ITEM_BDA_MODULATION_TYPE(GetHandler, SetHandler)                                         \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_MODULATION_TYPE, (GetHandler), sizeof(KSP_NODE), sizeof(ModulationType), \
                           (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_INNER_FEC_TYPE(GetHandler, SetHandler)                                    \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_INNER_FEC_TYPE, (GetHandler), sizeof(KSP_NODE), sizeof(FECMethod), \
                           (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_INNER_FEC_RATE(GetHandler, SetHandler)                 \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_INNER_FEC_RATE, (GetHandler), sizeof(KSP_NODE), \
                           sizeof(BinaryConvolutionCodeRate), (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_OUTER_FEC_TYPE(GetHandler, SetHandler)                                    \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_OUTER_FEC_TYPE, (GetHandler), sizeof(KSP_NODE), sizeof(FECMethod), \
                           (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_OUTER_FEC_RATE(GetHandler, SetHandler)                 \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_OUTER_FEC_RATE, (GetHandler), sizeof(KSP_NODE), \
                           sizeof(BinaryConvolutionCodeRate), (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_SYMBOL_RATE(GetHandler, SetHandler)                                              \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_SYMBOL_RATE, (GetHandler), sizeof(KSP_NODE), sizeof(ULONG), (SetHandler), \
                           NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_SPECTRAL_INVERSION(GetHandler, SetHandler)                 \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_SPECTRAL_INVERSION, (GetHandler), sizeof(KSP_NODE), \
                           sizeof(SpectralInversion), (SetHandler), NULL, 0, NULL, NULL, 0)
...
//
#define STATIC_KSPROPSETID_BdaAutodemodulate 0xddf15b12, 0xbd25, 0x11d2, 0x9c, 0xa0, 0x0, 0xc0, 0x4f, 0x79, 0x71, 0xe0
...
#define DEFINE_KSPROPERTY_ITEM_BDA_AUTODEMODULATE_START(GetHandler, SetHandler)                                    \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_AUTODEMODULATE_START, FALSE, sizeof(KSP_NODE), 0, (SetHandler), NULL, 0, \
                           NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_AUTODEMODULATE_STOP(GetHandler, SetHandler)                                    \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_AUTODEMODULATE_STOP, FALSE, sizeof(KSP_NODE), 0, (SetHandler), NULL, 0, \
                           NULL, NULL, 0)
...
#define STATIC_KSPROPSETID_BdaPmtProcessor 0x516b99c5, 0x971c, 0x4aaf, 0xb3, 0xf3, 0xd9, 0xfd, 0xa8, 0xa1, 0x5e, 0x16
...
#define DEFINE_KSPROPERTY_ITEM_BDA_PMTPROCESSOR_PMT(GetHandler, SetHandler)                                  \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_PMTPROCESSOR_PMT, (GetHandler), sizeof(KSP_NODE), sizeof(BDA_PMT), \
                           (SetHandler), NULL, 0, NULL, NULL, 0)
...
#define STATIC_KSPROPSETID_BdaDescriptor 0xde6a1c9e, 0x87df, 0x48aa, 0x95, 0xaa, 0x28, 0x9b, 0x7a, 0xa4, 0xf4, 0x9f
...
#define DEFINE_KSPROPERTY_ITEM_BDA_DESCRIPTOR_CAT_DESC(GetHandler, SetHandler)                 \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_DESCRIPTOR_CAT_DESC, (GetHandler), sizeof(KSP_NODE), \
                           sizeof(BDA_CAT_DESCRIPTOR), (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_DESCRIPTOR_ES_DESC(GetHandler, SetHandler)                 \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_DESCRIPTOR_ES_DESC, (GetHandler), sizeof(KSP_NODE), \
                           sizeof(BDA_ES_DESCRIPTOR), (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_DESCRIPTOR_PROGRAM_DESC(GetHandler, SetHandler)                 \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_DESCRIPTOR_PROGRAM_DESC, (GetHandler), sizeof(KSP_NODE), \
                           sizeof(BDA_PROGRAM_DESCRIPTOR), (SetHandler), NULL, 0, NULL, NULL, 0)
...
//
#define STATIC_KSPROPSETID_BdaEsMap 0xfa14a8b3, 0x6068, 0x48ef, 0x96, 0xdd, 0x53, 0x1, 0xb, 0x98, 0x5a, 0x7d
...
#define DEFINE_KSPROPERTY_ITEM_BDA_ESMAP_EMM_PIDS(GetHandler, SetHandler)                                           \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_ESMAP_EMM_PIDS, (GetHandler), sizeof(KSP_NODE), 0, (SetHandler), NULL, 0, \
                           NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_ESMAP_ECM_PIDS(GetHandler, SetHandler)                                              \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_ESMAP_ECM_PIDS, (GetHandler), sizeof(KSP_NODE_ESPID), 0, (SetHandler), NULL, \
                           0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_ESMAP_MAP_LIST(GetHandler, SetHandler)                                           \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_ESMAP_MAP_LIST, (GetHandler), sizeof(KSP_NODE), 0, (SetHandler), NULL, 0, \
                           NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_ESMAP_UPDATE_MAP(GetHandler, SetHandler)                                            \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_ESMAP_UPDATE_MAP, FALSE, sizeof(KSP_NODE), sizeof(BDA_ES_MAP), (SetHandler), \
                           NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_ESMAP_REMOVE_MAP(GetHandler, SetHandler)                                            \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_ESMAP_REMOVE_MAP, FALSE, sizeof(KSP_NODE), sizeof(BDA_ES_MAP), (SetHandler), \
                           NULL, 0, NULL, NULL, 0)
...
//
#define STATIC_KSPROPSETID_BdaPIDFilter 0xd0a67d65, 0x8df, 0x4fec, 0x85, 0x33, 0xe5, 0xb5, 0x50, 0x41, 0xb, 0x85
...
#define DEFINE_KSPROPERTY_ITEM_BDA_PIDFILTER_MAP_PIDS(GetHandler, SetHandler)                                      \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_PIDFILTER_MAP_PIDS, (GetHandler), sizeof(KSP_NODE), sizeof(BDA_PID_MAP), \
                           (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_PIDFILTER_UNMAP_PIDS(GetHandler, SetHandler)                                        \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_PIDFILTER_UNMAP_PIDS, (GetHandler), sizeof(KSP_NODE), sizeof(BDA_PID_UNMAP), \
                           (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_PIDFILTER_LIST_PIDS(GetHandler, SetHandler)                                        \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_PIDFILTER_LIST_PIDS, (GetHandler), sizeof(KSP_NODE), 0, (SetHandler), NULL, \
                           0, NULL, NULL, 0)
...
//
#define STATIC_KSPROPSETID_BdaCA 0xb0693766, 0x5278, 0x4ec6, 0xb9, 0xe1, 0x3c, 0xe4, 0x5, 0x60, 0xef, 0x5a
...
#define DEFINE_KSPROPERTY_ITEM_BDA_ECM_MAP_STATUS(GetHandler, SetHandler)                                              \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_ECM_MAP_STATUS, (GetHandler), sizeof(KSP_NODE), sizeof(ULONG), (SetHandler), \
                           NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_CA_MODULE_STATUS(GetHandler, SetHandler)                                \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_CA_MODULE_STATUS, (GetHandler), sizeof(KSP_NODE), sizeof(ULONG), \
                           (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_CA_SMART_CARD_STATUS(GetHandler, SetHandler)                                \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_CA_SMART_CARD_STATUS, (GetHandler), sizeof(KSP_NODE), sizeof(ULONG), \
                           (SetHandler), NULL, 0, NULL, NULL, 0)

#define DEFINE_KSPROPERTY_ITEM_BDA_CA_MODULE_UI(GetHandler, SetHandler)                                           \
    DEFINE_KSPROPERTY_ITEM(KSPROPERTY_BDA_CA_MODULE_UI, (GetHandler), sizeof(KSP_NODE), sizeof(BDA_CA_MODULE_UI), \
                           (SetHandler), NULL, 0, NULL, NULL, 0)
...
//
#define STATIC_KSEVENTSETID_BdaCAEvent 0x488c4ccc, 0xb768, 0x4129, 0x8e, 0xb1, 0xb0, 0xa, 0x7, 0x1f, 0x90, 0x68
...
#define DEFINE_KSEVENT_BDA_ECM_MAP_STATUS_CHANGED(AddHandler, RemoveHandler, SupportHandler)                       \
    DEFINE_KSEVENT_ITEM(KSEVENT_BDA_ECM_MAP_STATUS_CHANGED, sizeof(KSEVENTDATA), 0, (AddHandler), (RemoveHandler), \
                        (SupportHandler))

#define DEFINE_KSEVENT_BDA_CA_MODULE_STATUS_CHANGED(AddHandler, RemoveHandler, SupportHandler)                       \
    DEFINE_KSEVENT_ITEM(KSEVENT_BDA_CA_MODULE_STATUS_CHANGED, sizeof(KSEVENTDATA), 0, (AddHandler), (RemoveHandler), \
                        (SupportHandler))

#define DEFINE_KSEVENT_BDA_CA_SMART_CARD_STATUS_CHANGED(AddHandler, RemoveHandler, SupportHandler)      \
    DEFINE_KSEVENT_ITEM(KSEVENT_BDA_CA_SMART_CARD_STATUS_CHANGED, sizeof(KSEVENTDATA), 0, (AddHandler), \
                        (RemoveHandler), (SupportHandler))

#define DEFINE_KSEVENT_BDA_CA_MODULE_UI_REQUESTED(AddHandler, RemoveHandler, SupportHandler)                       \
    DEFINE_KSEVENT_ITEM(KSEVENT_BDA_CA_MODULE_UI_REQUESTED, sizeof(KSEVENTDATA), 0, (AddHandler), (RemoveHandler), \
                        (SupportHandler))
...
#define STATIC_KSCATEGORY_BDA_NETWORK_TUNER 0x71985f48, 0x1ca1, 0x11d3, 0x9c, 0xc8, 0x0, 0xc0, 0x4f, 0x79, 0x71, 0xe0
...
#define STATIC_KSCATEGORY_BDA_NETWORK_EPG 0x71985f49, 0x1ca1, 0x11d3, 0x9c, 0xc8, 0x0, 0xc0, 0x4f, 0x79, 0x71, 0xe0
...
#define STATIC_KSCATEGORY_BDA_IP_SINK 0x71985f4aL, 0x1ca1, 0x11d3, 0x9c, 0xc8, 0x00, 0xc0, 0x4f, 0x79, 0x71, 0xe0
...
#define STATIC_KSCATEGORY_BDA_NETWORK_PROVIDER 0x71985f4b, 0x1ca1, 0x11d3, 0x9c, 0xc8, 0x0, 0xc0, 0x4f, 0x79, 0x71, 0xe0
...
#define STATIC_KSNODE_BDA_RF_TUNER 0x71985f4c, 0x1ca1, 0x11d3, 0x9c, 0xc8, 0x0, 0xc0, 0x4f, 0x79, 0x71, 0xe0
...
#define STATIC_KSNODE_BDA_QAM_DEMODULATOR 0x71985f4d, 0x1ca1, 0x11d3, 0x9c, 0xc8, 0x0, 0xc0, 0x4f, 0x79, 0x71, 0xe0
...
#define STATIC_KSNODE_BDA_QPSK_DEMODULATOR 0x6390c905, 0x27c1, 0x4d67, 0xbd, 0xb7, 0x77, 0xc5, 0xd, 0x7, 0x93, 0x0
...
#define STATIC_KSNODE_BDA_8VSB_DEMODULATOR 0x71985f4f, 0x1ca1, 0x11d3, 0x9c, 0xc8, 0x0, 0xc0, 0x4f, 0x79, 0x71, 0xe0
...
#define STATIC_KSNODE_BDA_OPENCABLE_POD 0xd83ef8fc, 0xf3b8, 0x45ab, 0x8b, 0x71, 0xec, 0xf7, 0xc3, 0x39, 0xde, 0xb4
...
#define STATIC_KSNODE_BDA_PID_FILTER 0xf5412789, 0xb0a0, 0x44e1, 0xae, 0x4f, 0xee, 0x99, 0x9b, 0x1b, 0x7f, 0xbe
...
#define STATIC_KSNODE_BDA_IP_SINK 0x71985f4e, 0x1ca1, 0x11d3, 0x9c, 0xc8, 0x0, 0xc0, 0x4f, 0x79, 0x71, 0xe0
...
#define STATIC_PINNAME_IPSINK_INPUT 0x3fdffa70L, 0xac9a, 0x11d2, 0x8f, 0x17, 0x00, 0xc0, 0x4f, 0x79, 0x71, 0xe2
...
#define STATIC_PINNAME_MPE 0xc1b06d73L, 0x1dbb, 0x11d3, 0x8f, 0x46, 0x00, 0xC0, 0x4f, 0x79, 0x71, 0xE2
...
//
#define STATIC_KSDATAFORMAT_TYPE_MPE 0x455f176c, 0x4b06, 0x47ce, 0x9a, 0xef, 0x8c, 0xae, 0xf7, 0x3d, 0xf7, 0xb5
