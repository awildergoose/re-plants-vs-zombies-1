...
extern "C"
{
    ...
    typedef enum _AM_ASPECT_RATIO_MODE
    {
        ...
        AM_ARMODE_STRETCHED_AS_PRIMARY  // follow whatever the primary stream does (in terms of the mode as well as
    ...
    DECLARE_INTERFACE_(IMixerPinConfig, IUnknown)
    {
        ...
        STDMETHOD(SetRelativePosition)(THIS_ IN DWORD dwLeft, IN DWORD dwTop, IN DWORD dwRight, IN DWORD dwBottom) PURE;
        ...
        STDMETHOD(GetRelativePosition)(THIS_ OUT DWORD * pdwLeft, OUT DWORD * pdwTop, OUT DWORD * pdwRight,
