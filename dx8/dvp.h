...
#define IVideoPort_WaitForSync(p, a, b, c) (p)->WaitForSync(a, b, c)
    ...
    typedef struct _DDVIDEOPORTCAPS
    {
        ...
        WORD  wNumFilterTapsX;  // Number of taps the prescaler uses in the X direction (0 - no prescale, 1 -
                                // replication, etc.)
        WORD wNumFilterTapsY;   // Number of taps the prescaler uses in the Y direction (0 - no prescale, 1 -
                                // replication, etc.)
    } DDVIDEOPORTCAPS;
