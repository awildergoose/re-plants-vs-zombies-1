...
#define IID_IDirectMusicPort8 IID_IDirectMusicPort
     ...
     *
     * Item 0: The MIDINCAPS or MIDIOUTCAPS which describes the port's underlying WinMM device. This property is only
     * supported by ports which wrap WinMM devices.
     */
